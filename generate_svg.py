svg = """
<svg viewBox="0 0 500 500" fill="none" stroke="#ffffff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" style="background: #e23137;">
    ...
    <!-- Decorative geometric/artistic elements -->
    ...
    <!-- Dotted abstract accent lines (artistic flair) -->
    <circle cx="100" cy="150" r="3" fill="#ffffff" stroke="none" />
    <path d="M 100 150 L 150 100" stroke-width="1" stroke-dasharray="2 4" opacity="0.5" />
    
    <circle cx="400" cy="100" r="4" fill="none" stroke-width="1.5" opacity="0.8" />
    <path d="M 400 100 L 350 150" stroke-width="1" stroke-dasharray="2 4" opacity="0.5" />
    
</svg>
"""
open("test_laminate.svg", "w").write(svg)
print("SVG Generated.")
