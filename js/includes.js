    ...
    if ((mainImage || cardGrid || editorialContainer || isAboutUs) && pageContent) {
      setTimeout(function() {
        ...
        if (window.scrollY < 50) {
          ...
          // Subtracting 120px gives plenty of breathing room below the header
          var offsetPosition = elementPosition + window.scrollY - headerOffset - 120;
...
// V3 BANNER AUTO SCROLL removed to prevent scroll conflicts
